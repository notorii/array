...
*/
notoriiArray.remove =function(arrOrig, from, to, params) {
...
*/
notoriiArray.findArrayIndex =function(array, key, val, params) {
  var ii;
  var index =-1;
  if(params.oneD)
  {
...
*/
notoriiArray.sort2D =function(arrayUnsorted, column, params) {
